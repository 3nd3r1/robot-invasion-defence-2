...
class TestTower(unittest.TestCase):
    ...
    def test_tower_targets_robot_in_range(self):
        ...
        self.assertEqual(self.test_tower.target, self.test_robot)
    ...
    def test_tower_shoots_at_target(self):
        ...
        self.assertEqual(len(self.test_game.sprites.projectiles), 0)

        # Does tower shoot at robot?
        pygame.time.wait(1000)
        self.test_game.update()
        self.assertEqual(len(self.test_game.sprites.projectiles), 1)
